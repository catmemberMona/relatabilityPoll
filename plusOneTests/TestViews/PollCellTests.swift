...
class PollCellTests: XCTestCase {
    ...
    func testCell_Config_ShouldSetLabelsToPollData(){
        let cell = tableView.dequeueReusableCell(withIdentifier: K.pollCellId, for: IndexPath(row: 0, section: 0)) as! PollCell
